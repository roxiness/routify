...
export const scopedScrollIntoView = async (_elem, _boundary) => {
    ...
    while (
        ...
        /**
         * If this is a not an inlined page, we want to scroll it into view in its parent element.
         * If this is an inlined page, we want want to scroll it into view of the nearest non inlined ancestor element.
         */
