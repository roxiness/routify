...
const createUrl =
    ...
    (_inputPath, userParams = {}, options = {}) => {
        const inputIsElement = _inputPath instanceof HTMLElement
        // if we're dealing with an anchor element, get the href
        const inputPath = _inputPath.getAttribute?.('href') || _inputPath
        ...
        if (inputIsElement) _inputPath.setAttribute('href', externalUrl)
        else return externalUrl
    }
