...
export const getLogLevel = () =>
    typeof window === 'undefined'
        ...
        : window.__routify?.debugLevel || localStorage.getItem('__routify.debugLevel')
...
export const context = {
    /** @type {Router} */
    get router() {
        return getContext('routify-component').route.router
    },
    get component() {
        return getContext('routify-component')
    },
}
