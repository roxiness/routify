...
const urlWithoutDefault = 'rtf:r2=/r2/address;rtf:r3=/r3/address'
const urlWithDefault = '/primary/address;rtf:r2=/r2/address;rtf:r3=/r3/address'

const router1 = { name: '', url: '/primary/address' }
const router2 = { name: 'r2', url: '/r2/address' }
const router3 = { name: 'r3', url: '/r3/address' }
