...
<div class="getting-started">
    ...
    <p>
        This is a simple todo app that uses Triplit. You can add, complete, and delete
        todos.
    </p>
    <h2>Explore the project</h2>
    <p>
        This app is built with <a href={ROOT}>Triplit</a>,{' '}
        <a href="https://routify.dev">Routify</a> and{' '}
    ...
    <h2>Watch it sync</h2>
    <p>
        <a target="_blank" href="http://localhost:5173">Open the app in a new tab</a>. You
        should see the todos you added in the other window.
    </p>
    <h2>Go offline</h2>
