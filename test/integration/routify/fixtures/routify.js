    ...
    children: [
        {
            ...
            component: import('./bundles/_default_admin-bundle.js').then(
                (r) => r._default_admin,
            ),
            id: '_default_admin',
            name: 'admin',
            ...
            children: [
                {
                    meta: {},
                    component: import(
                        './bundles/_default_admin-bundle.js'
                    ).then((r) => r._default_admin_bundleme_svelte),
                    id: '_default_admin_bundleme_svelte',
                    name: 'bundleme',
                    file: {
                        path:
                            'test/integration/routify/example/admin/bundleme.svelte',
                        dir: 'test/integration/routify/example/admin',
            ...
            children: [
                {
                    ...
                    file: {
                        path:
                            'test/integration/routify/example/blog/[slug].svelte',
                ...
                },
                {
                    ...
                    file: {
                        path:
                            'test/integration/routify/example/blog/prefixed[slug].svelte',
                        dir: 'test/integration/routify/example/blog',
            ...
            children: [
                {
                    ...
                    file: {
                        path:
                            'test/integration/routify/example/no-layouts/nested',
                    ...
                    children: [
                        {
                            ...
                            file: {
                                path:
                                    'test/integration/routify/example/no-layouts/nested/foo.svelte',
                                dir:
                                    'test/integration/routify/example/no-layouts/nested',
                                base: 'foo.svelte',
                                ext: '.svelte',
                        ...
                        },
                        {
                            ...
                            file: {
                                path:
                                    'test/integration/routify/example/no-layouts/nested/index.svelte',
                                dir:
                                    'test/integration/routify/example/no-layouts/nested',
                                base: 'index.svelte',
                                ext: '.svelte',
